...
return function(route)
    ...
    route:get('/users/access_tokens', 'users@accessTokens'):name('users.access_tokens')
    ...
    route:get('/users/edit_email_notify', 'users@editEmailNotify'):name('users.edit_email_notify')
    route:post('/users/update_email_notify', 'users@updateEmailNotify'):name('users.update_email_notify')
    route:get('/users/edit_password', 'users@editPassword'):name('users.edit_password')
    route:post('/users/update_password', 'users@updatePassword'):name('users.update_password')
    route:get('/users/edit_social_binding', 'users@editSocialBinding'):name('users.edit_social_binding')
    route:get('/users/social_unbinding', 'users@socialUnbinding'):name('users.social_unbinding')
    ...
    route:get('/u/{id}', 'users@show'):name('users.show')
    route:get('/users/edit', 'users@edit'):name('users.edit')
    route:post('/users/update', 'users@update'):name('users.update')
    route:get('/users/edit_avatar', 'users@editAvatar'):name('users.edit_avatar')
    route:post('/users/update_avatar', 'users@updateAvatar'):name('users.update_avatar')
    ...
    ------------------ Categories------------------------
    route:get('c/{id}', 'categories@show'):name('categories.show')
    ------------------ Site------------------------
