return {
    ...
    site_intro = 'orhub is a openresty & lua Developer Forum, More Intro <a href="about">See Here</a>.',
    contributing = 'This project is under developement, Please feel free to <i class="fa fa-github" style="font-size:15px"></i> <a href="https://github.com/summerblue/orhub5" target="_blank">Contribute to the code</a> OR <a href="https://github.com/summerblue/orhub5/issues" target="_blank">Submit an Issue</a>.',
