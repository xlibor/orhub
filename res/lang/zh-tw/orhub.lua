return {
    ...
    contributing = '功能正在開發中, 歡迎 <i class="fa fa-github" style="font-size:15px"></i> <a href="https://github.com/laravel.tw/orhub" target="_blank">貢獻程式碼</a> 或 <a href="https://github.com/laravel.tw/orhub/issues" target="_blank">提交 Issue</a>.',
