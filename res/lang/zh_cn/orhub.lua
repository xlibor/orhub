...
return {
    ...
    site_intro = 'orhub 是综合的 openresty 和 lua 开发者社区，Powered By <a class="popover-with-html" data-content="查看源代码" target="_blank" style="padding-right:8px;" href="https://github.com/xlibor/orhub"  data-original-title="" title=""><i class="fa fa-github-alt text-md" aria-hidden="true"></i> orhub</a>',
