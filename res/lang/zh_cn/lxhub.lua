...
local url, route = lx.h.url, lx.h.route
...
return {
    ...
    ['Weibo Username example: orhub'] = '如：xlibor',
    ...
    site_intro = 'orhub 是综合的 openresty 和 lua 开发者社区，Powered By <a class="popover-with-html" data-content="查看源代码" target="_blank" style="padding-right:8px" href="https://github.com/xlibor/lxlib" data-original-title="" title=""><i class="fa fa-github-alt text-md" aria-hidden="true"></i> orhub</a>',
    contributing = '功能正在完善中, 欢迎 <i class="fa fa-github" style="font-size:15px"></i> <a href="https://github.com/summerblue/orhub5" target="_blank">贡献代码</a> 或 <a href="https://github.com/summerblue/orhub5/issues" target="_blank">提交 Issue</a>.',
    be_nice = '我们希望 orhub 能够成为拥有浓厚技术氛围的开发者社区，而实现这个目标，需要我们所有人的共同努力：友善，公平，尊重知识和事实。请严格遵守 - <a href="https://laravel-china.org/topics/3022">社区发帖和管理规范</a>',
    ...
    ['Congratulations and Welcome!'] = '恭喜，欢迎加入 orhub 社区！',
    ...
    ['Already binded'] = '已绑定',
    ['Unbind to this account'] = '解绑',
    ['Bind to this account'] = '绑定帐号',
    ['Already unbinded'] = '已解除绑定',
    ['Setup multiple Bindings allow you to login to the same account with different binding site account.'] = '绑定多个第三方账号，允许你使用任意一个第三方账号登录同一个 orhub 账号。',
    ['Photo Upload'] = '上传头像',
    ...
    ['The mail send failed! Please fill in your email address first.'] = '邮箱不存在，请点击 <a href="' .. url(route('users.edit')) .. '" target="_blank">此处</a> 编辑你的邮箱！',
    ...
    ['Bind Successfully!'] = '绑定成功！以后可以使用你的 :driver 账号登录 orhub 了 ^_^',
    Actived = '最近访问'
}