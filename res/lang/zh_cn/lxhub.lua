...
return {
    ...
    contributing = '功能正在完善中, 欢迎 <i class="fa fa-github" style="font-size:15px"></i> <a href="https://github.com/summerblue/lxhub5" target="_blank">贡献代码</a> 或 <a href="https://github.com/summerblue/lxhub5/issues" target="_blank">提交 Issue</a>.',
