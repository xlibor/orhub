...
function _M:run()
    ...
    \DB.table('banners'):insert({
        ...
        order = 1,
        image_url = 'https://dn-lxhub.qbox.me/uploads/banners/qCpz5a1iBETEfnNEAkGe.png',
        ...
        position = 'website_top',
        order = 3,
        image_url = 'https://dn-lxhub.qbox.me/uploads/banners/YCkIqPrz6v8MV0keu4pW.png',
        title = 'Laravel 速查表',
        ...
        position = 'website_top',
        order = 2,
        image_url = 'https://dn-lxhub.qbox.me/uploads/banners/0wgbAVabZB9GA2yaU8AY.png',
        title = '酷工作',
        link = 'categories/1',
        target = '_self',
        ...
        position = 'website_top',
        order = 4,
        image_url = 'https://dn-lxhub.qbox.me/uploads/banners/0pyH7UgXhF7PTBkLZRak.png',
        title = 'PSR PHP 标准规范',
        ...
        position = 'website_top',
        order = 6,
        image_url = 'https://dn-lxhub.qbox.me/uploads/banners/HCNo4rSRxIpK12yDL13U.png',
        title = '新手入门 PHP 之道',
        ...
        position = 'website_top',
        order = 5,
        image_url = 'https://dn-lxhub.qbox.me/uploads/banners/EptWCkT1qDDvtn5nV2id.png',
